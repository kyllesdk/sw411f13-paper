...
<expression> -> <variable> (+ | - | *) <variable>;
\end{lstlisting}
\todo{EBNF have to be reviewed now the transition rules have been made.}
\section{Semantics}
The semantics of a language is the description of what happens when a program is executed. \todo{Add some text about the Transition rules role in the project.}
