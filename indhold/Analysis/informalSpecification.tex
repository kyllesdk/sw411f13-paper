...
\begin{itemize}
\item \textbf{Int} or integer does not include floating point numbers and can hold numbers between $-32.768$ and $32.767$. Unsigned integers have a range from $0$ to $65.535$. \todo{Morten: unsigned og signed?}
