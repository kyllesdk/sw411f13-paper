...
\begin{itemize}
\item \textbf{Int} or integer does not include floating point numbers, and can only hold numbers between $-32.768$ and $32.767$. If however it is unsigned it can range from $0$ to $65.535$. \todo{Morten: Hvem har været her? Blev vi ikke enige om ingen unsigned?}
