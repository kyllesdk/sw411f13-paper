...
This is the second example of how the new language looks like. Just like in the first syntax example \todo{ref to first syntax example}, then this is an example derived from a code in the original Arduino language. The original code can be found in Appendix \todo{insert ref to appendix second_syntax_example_original here}.
\begin{lstlisting}
