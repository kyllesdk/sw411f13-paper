\section{Original Syntax Example 2} \label{second_syntax_example}
This is the second example of the original way to write code to Arduino. This is about the LCD example.
\begin{lstlisting}[caption=This is the second original Arduino example, label=lst:second_syntax_example]
