...
\subsection*{Implementation}To keep it simple and easy for the user, only the call-by-value method will be implemented in PH\todo{Name for source language placeholder}, this will allow for passing of parameters to functions, while keeping it simple, by not including features like pointers, to help confuse the user with more then one way of accomplishing a certain task.
